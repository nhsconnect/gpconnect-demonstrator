...
DROP DATABASE IF EXISTS gpconnect0_7;
CREATE DATABASE gpconnect0_7 DEFAULT CHARACTER SET utf8;

/* Delete the answer user (grant all to workaround MySQL not supporting 'IF EXISTS' for users) */
GRANT ALL ON gpconnect0_7.* TO 'answer' IDENTIFIED BY 'answer99q';
DROP USER 'answer';
FLUSH PRIVILEGES;
...
GRANT ALL ON gpconnect0_7.* TO 'answer'@'%' IDENTIFIED BY 'answer99q';
GRANT ALL ON gpconnect0_7.* TO 'answer'@'localhost' IDENTIFIED BY 'answer99q';
FLUSH PRIVILEGES;
