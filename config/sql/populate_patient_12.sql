...
UPDATE gpconnect1.medication_statements SET medicationRequestId = 15 WHERE id = 7;
UPDATE gpconnect1.medication_statements SET medicationRequestId = 17 WHERE id = 8;
