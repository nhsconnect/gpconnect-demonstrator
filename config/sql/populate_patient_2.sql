...
VALUES
  ...
  (9658218873 ,"Repeat",'2015-05-01',"Metformin 500mg tablets","one tablet 2 to 3 times daily","28 days",NULL,NULL,"Take one tablet three times daily",'2018-03-28','2018-10-15',3,6,"",""),
  (9658218873 ,"Repeat",'2006-03-01',"Lercanidipine 20mg tablets","one tablet daily","28 days",NULL,NULL,"Take one tablet daily",'2018-03-20','2018-10-15',3,6,"",""),
  (9658218873 ,"Past",'1978-09-03',"Chloramphenicol eye drops preservative free 0.5%","one drop in the affected eye every 2 hours","5 days",NULL,NULL,"1 drop in left eye four times daily for 4 weeks.",NULL,NULL,NULL,NULL,"NHS Medication","r2");
