...
public class CancerMDTCompositionConverter extends BaseCompositionConverter<CancerMDT> {
    ...
    protected CancerMDT create(Map<String, Object> rawComposition, String prefix) {
        ...
        try {
            Date dateTime = openEHRDateFormat.parse(MapUtils.getString(rawComposition, "cancer_mdt_output_report/referral_details:" + index + "/mdt_referral/request:0/date_or_time_service_required"));
