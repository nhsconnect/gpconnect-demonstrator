 ...
 */
@Component
public class FindLabOrdersRouteBuilder extends SpringRouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        //@formatter:off
        from("direct:findLabOrders").routeId("FindLabOrders")
            ...
            .choice()
                .when(body().isNotNull())
                    .split(simple("${body.resultSet}"), new DefaultAggregationStrategy<LabOrder>())
