 ...
 */
package uk.gov.hscic.patient.allergies.store;

import uk.gov.hscic.patient.allergies.store.NotConfiguredAllergyStore;
...
public class NotConfiguredAllergyStoreTest {
    ...
    public void shouldReportAsNotConfiguredImplementation() {
        assertEquals(RepoSourceType.NONE, allergyStore.getSource());
    }
