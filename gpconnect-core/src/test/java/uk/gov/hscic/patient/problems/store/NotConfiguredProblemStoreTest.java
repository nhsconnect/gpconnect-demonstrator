 ...
 */
package uk.gov.hscic.patient.problems.store;

import uk.gov.hscic.patient.problems.store.NotConfiguredProblemStore;
...
public class NotConfiguredProblemStoreTest {
    ...
    public void shouldReportAsNotConfiguredImplementation() {
        assertEquals(RepoSourceType.NONE, problemStore.getSource());
    }
