...
public class TestResultsBuilder {
    ...
    private DiagnosticReport getDiagnosticReport() {
        ...
        try {
            diagnosticReport.setIssued(DATE_FORMATTER.parse("2019-04-03T12:00:00+00:00"));
    ...
    private Specimen getSpecimen() {
        ...
        try {
            specimen.setReceivedTime(DATE_FORMATTER.parse("2017-11-01T15:00:00+00:00"));

            Specimen.SpecimenCollectionComponent collection = new Specimen.SpecimenCollectionComponent();
            collection.setCollected(new DateTimeType(DATE_FORMATTER.parse("2019-04-01T11:00:00+00:00")));
