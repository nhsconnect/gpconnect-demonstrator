...
import uk.gov.hscic.common.service.AbstractQueryStrategy;
import uk.gov.hscic.patient.observations.model.ObservationDetails;

/**
 */
public class LabResultDetailsQueryStrategy extends AbstractQueryStrategy<ObservationDetails> {
    ...
    @Override
    public ObservationDetails transform(List<Map<String, Object>> resultSet) {
