...
import uk.gov.hscic.common.service.AbstractListQueryStrategy;
import uk.gov.hscic.patient.observations.model.ObservationSummary;

/**
 */
public class LabResultSummaryQueryStrategy extends AbstractListQueryStrategy<ObservationSummary> {
    ...
    @Override
    public List<ObservationSummary> transform(List<Map<String, Object>> resultSet) {
