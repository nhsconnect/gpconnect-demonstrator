...
/**
 */
public class LabResultSummaryTransformer implements Transformer<Map<String, Object>, ObservationSummary> {

    @Override
    public ObservationSummary transform(Map<String, Object> input) {
        ...
        ObservationSummary labResult = new ObservationSummary();
