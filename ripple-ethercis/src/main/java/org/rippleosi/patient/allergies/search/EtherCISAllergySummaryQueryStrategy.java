...
/**
 */
public class EtherCISAllergySummaryQueryStrategy extends AbstractEtherCISListQueryStrategy<AllergySummary> {

    EtherCISAllergySummaryQueryStrategy(String patientId) {
        super(patientId);
    }
