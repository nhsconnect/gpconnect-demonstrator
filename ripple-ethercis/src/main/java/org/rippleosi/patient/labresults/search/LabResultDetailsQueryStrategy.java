...
public class LabResultDetailsQueryStrategy extends AbstractEtherCISQueryStrategy<LabResultDetails> {
    ...
    public String getQuery(String namespace, String ehrId) {
        return "SELECT ehr.entry.composition_id as uid, " +
                ...
                "ehr.entry.entry #>> " +
                "'{" +
                "/composition[openEHR-EHR-COMPOSITION.report-result.v1 and name/value=''Laboratory test report''], /content[openEHR-EHR-OBSERVATION.laboratory_test.v0],0, /data[at0001],/events,/events[at0002],0, /time,/value,value" +
                "}' as sample_taken, " +
                "ehr.entry.entry #>> " +
                "'{" +
                "/composition[openEHR-EHR-COMPOSITION.report-result.v1 and name/value=''Laboratory test report''], /content[openEHR-EHR-OBSERVATION.laboratory_test.v0],0, /data[at0001],/events,/events[at0002],0, /data[at0003],/items[at0005 and name/value=''Test name''],/value,value" +
                "}' as test_name, " +
                "ehr.entry.entry #>>" +
                "'{" +
                "/composition[openEHR-EHR-COMPOSITION.report-result.v1 and name/value=''Laboratory test report''], /content[openEHR-EHR-OBSERVATION.laboratory_test.v0],0, /data[at0001],/events,/events[at0002],0, /data[at0003],/items[at0057 and name/value=''Conclusion''],/value,value" +
                "}' as conclusion," +
                "ehr.entry.entry #>>" +
                "'{" +
                "/composition[openEHR-EHR-COMPOSITION.report-result.v1 and name/value=''Laboratory test report''], /content[openEHR-EHR-OBSERVATION.laboratory_test.v0],0, /data[at0001],/events,/events[at0002],0, /data[at0003],/items[at0073 and name/value=''Test status''],/value,value" +
                "}' as status" +
                "FROM ehr.entry " +
                ...
                "WHERE (ehr.composition.ehr_id='" + ehrId + "') AND (ehr.entry.archetype_Id = 'openEHR-EHR-COMPOSITION.report-result.v1') " +
