...
/**
 */
public class EtherCISProblemSummaryQueryStrategy extends AbstractEtherCISListQueryStrategy<ProblemSummary> {

    EtherCISProblemSummaryQueryStrategy(String patientId) {
        super(patientId);
    }
