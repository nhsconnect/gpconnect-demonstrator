...
public class ProblemDetailsQueryStrategy extends AbstractEtherCISQueryStrategy<ProblemDetails> {
    ...
    public String getQuery(String namespace, String ehrId) {
        return "SELECT ehr.entry.composition_id as uid, " +
                ...
                "ehr.entry.entry #>> " +
                "'{" +
                "/composition[openEHR-EHR-COMPOSITION.problem_list.v1 and name/value=''Problem list''], /content[openEHR-EHR-SECTION.problems_issues_rcp.v1],0, /items[openEHR-EHR-EVALUATION.problem_diagnosis.v1],0, /data[at0001],/items[at0002 and name/value=''Problem/Diagnosis name''],/value,definingCode,codeString" +
                "}' as problem_code, " +
                "ehr.entry.entry #>> " +
                "'{" +
                "/composition[openEHR-EHR-COMPOSITION.problem_list.v1 and name/value=''Problem list''], /content[openEHR-EHR-SECTION.problems_issues_rcp.v1],0, /items[openEHR-EHR-EVALUATION.problem_diagnosis.v1],0, /data[at0001],/items[at0002 and name/value=''Problem/Diagnosis name''],/value,definingCode,terminologyId,value" +
                ...
                "ehr.entry.entry #>> " +
                "'{" +
                "/composition[openEHR-EHR-COMPOSITION.problem_list.v1 and name/value=''Problem list''], /content[openEHR-EHR-SECTION.problems_issues_rcp.v1],0, /items[openEHR-EHR-EVALUATION.problem_diagnosis.v1],0,/data[at0001],/items[at0009 and name/value=''Clinical description''],/value,value" +
                "}' as description " +
                "FROM ehr.entry " +
                ...
                "WHERE (ehr.composition.ehr_id='" + ehrId + "') AND (ehr.entry.archetype_Id = 'openEHR-EHR-COMPOSITION.problem_list.v1') " +
