...
angular.module('gpConnect')
  .factory('Observation', function ($http, EnvConfig) {

    var findAllHTMLTables = function(patientId, source) {
      return $http.post(EnvConfig.restUrlPrefix+'/Patient/$getcarerecord',
        '{"resourceType" : "Parameters","parameter" : [{"name" : "patientNHSNumber","valueIdentifier" : { "value" : "'+patientId+'" }},{"name" : "recordSection","valueString" : "Observations"},{"name" : "timePeriod","valuePeriod" : { "start" : "2015", "end" : "2016" }}]}',
        {
            headers: {
